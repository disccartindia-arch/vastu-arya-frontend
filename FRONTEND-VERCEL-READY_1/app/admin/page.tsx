...
import { TrendingUp, Users, ShoppingBag, Calendar, Layers, Package, Eye } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      {data?.revenueChart && data.revenueChart.length > 0 && (
        <div className="bg-white rounded-2xl p-6 shadow-sm">
          <h2 className="font-semibold text-gray-800 mb-4 flex items-center gap-2"><TrendingUp size={18} className="text-primary" /> Revenue (Last 30 Days)</h2>
      ...
      <div className="bg-white rounded-2xl p-5 shadow-sm">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            ...
            <Link key={a.href} href={a.href} className="flex items-center gap-2 p-3 rounded-xl border border-gray-200 hover:border-primary hover:bg-primary-50 transition-all text-sm font-medium text-gray-600 hover:text-primary">

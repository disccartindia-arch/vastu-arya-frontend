          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-text-mid leading-relaxed mb-4">Dr. PPS is one of India's most respected Vastu Shastra experts, holding a prestigious Doctorate degree in Vastu Vadana. Awarded by the International Vedic Astrology Federation (IVAF LLC, USA) and recognized in New Delhi, Dr. PPS has transformed over 10,000 lives through authentic Vastu and Astrology guidance.</p>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[{n:'10,000+',l:'Happy Clients'},{n:'15+',l:'Years Experience'},{n:'100+',l:'Services Offered'},{n:'50+',l:'Cities Covered'}].map((s,i)=>(
              ...
              <div className="space-y-4">
                {[
                  ...
                  {icon:Users, title:'10,000+ Transformations', desc:'Over a decade of successfully transforming homes and lives'},
                ].map((c,i)=>(

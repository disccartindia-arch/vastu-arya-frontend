...
export default function Navbar() {
  ...
  const [brand, setBrand] = useState({ name: 'Vastu Arya', subtitle: 'IVAF Certified', fontSize: '18', phone: '+91-9999999999' });
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <div>
                <div className="font-display font-bold leading-none" style={{ color: '#1A0A00', fontSize: `${brand.fontSize}px` }}>{brand.name}</div>

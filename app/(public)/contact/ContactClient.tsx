            ...
            <div className="grid lg:grid-cols-2 gap-12">
              <div>
                ...
                <div className="space-y-4 mb-8">
                  {[{icon:Phone, label:'Phone',val:contact.phone},{icon:Mail, label:'Email',val:contact.email},{icon:MapPin, label:'Location',val:contact.address}].map((c,i)=>(
                ...
                <a href={`https://wa.me/${contact.whatsapp}`} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#128C7E] text-white py-4 rounded-2xl font-bold transition-all">

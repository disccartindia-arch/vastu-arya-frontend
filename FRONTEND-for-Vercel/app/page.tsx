...
import { servicesAPI, productsAPI, contentAPI } from '../lib/api';
...
export default function HomePage() {
  ...
  const stats = [
    { num: c('stats', 'clients', '45,000+'), label: lang === 'en' ? 'Happy Clients' : 'खुश ग्राहक' },
    { num: c('stats', 'experience', '15+'), label: lang === 'en' ? 'Years Experience' : 'साल का अनुभव' },
    { num: c('stats', 'services', '100+'), label: lang === 'en' ? 'Services' : 'सेवाएं' },
    { num: c('stats', 'cities', '50+'), label: lang === 'en' ? 'Cities Served' : 'शहरों में सेवा' },
  ];

...
export default function Navbar() {
  ...
  const { lang, setLang, setShowAppointmentPopup, mobileMenuOpen, setMobileMenuOpen, setShowCartDrawer, contactNumber } = useUIStore();
  ...
  // Displayed contact number — from admin settings or default
  const displayPhone = contactNumber || '+91-9999999999';
    ...
    <>
      ...
      <div className="text-white text-xs py-1.5 px-4 flex items-center justify-between" style={{ background: '#0D0500' }}>
        <div className="flex items-center gap-4">
          <a href={telHref} className="hover:text-yellow-400 transition-colors" style={{ color: '#D4A017' }}>
            {displayPhone}
          </a>
